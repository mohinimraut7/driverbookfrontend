...
export const navItems = [
  { label: "HOME", path: "/" },
  { label: "DRIVER SERVICE", path: "/driverservice" },
 {
    label: "CITY",
    path: "/city",               // fallback if you click the label
    dropdown: [
      { label: "Mumbai",      path: "/city/mumbai" },
      { label: "Navi Mumbai", path: "/city/navi-mumbai" },
      { label: "Thane",       path: "/city/thane" },
      { label: "Pune",        path: "/city/pune" },
    ],
  },
